...
void loop()
{
  ...
  */
   ...
   sendData(0x00, pin2);
   delay(500);
    sendData(0x00, pin3); //binair 00000000, 00000100 //zet poort 2 van GP0 hoog, de rest laag, pin 23 van de MCP23016 (GP0.2)
    delay(500); //wacht 500 ms
    sendData(0x00, pin4 ); //binair 00000000, 00001000 //zet poort 3 van GP0 hoog, de rest laag, pin 24 van de MCP23016 (GP0.3)
    delay(500); //wacht 500 ms
    sendData(0x00, pin5);
    delay(500);
     sendData(0x00, pin6);
